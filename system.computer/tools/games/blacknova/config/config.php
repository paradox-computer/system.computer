...
$game_name                  = 'BlackNova Traders';              // Please set this to a unique name for your game
...
$link_forums                = 'https://system.computer/tools/games/blacknova';    // Address for the forum link
$email_server               = 'mail.example.com';               // What mail server (an FQDN DNS name) should emails be sent from?
$adminpass                  = 'Vermont@34';                         // The administrator password
$admin_mail                 = 'admin@system.computer';              // The administrator email address
$adminname                  = 'jordan@laf.land';                     // The title for the administrator (used when emailing)
